...
pub enum Cw20HookMsg {
    /// StakeVotingTokens a user can stake their oraix token to receive rewards
    /// or do vote on polls
    StakeVotingTokens {},
    ...
    CreatePoll {
        ...
        description: String,
        link: Option<String>,
        execute_msg: Option<PollHandleMsg>,
...
pub struct PollResponse {
    ...
    pub execute_data: Option<PollHandleMsg>,
